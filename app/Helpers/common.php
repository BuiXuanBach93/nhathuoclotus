...
function uploadImageToGCP($file)
{
    ...
    $bucket = $storage->bucket('nhathuoclotus');
...
{
    $domain = env('DOMAIN', 'https://nhathuoclotus.com');
...
function processImageContent($content)
{
    ...
    $replacement = '<img alt="$1" data-src="$2" src="https://nhathuoclotus.com/images/images/loader.svg" ';
