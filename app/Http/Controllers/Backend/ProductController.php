...
class ProductController extends AppBaseController
{
    ...
    public function store(CreateNewsRequest $request)
    {
        ...
        try {
            ...
            if(!$params['provider_id']) {
                if(empty($params['nation'])){
                    $params['nation'] = "Đang cập nhật";
                }
    ...
    public function edit($id)
    {
        ...
        $currentUser = Auth::user();
        if ($currentUser->role != User::ROLE_ADMIN && $currentUser->role != User::ROLE_ADMIN_EDITOR && $currentUser->id != $product->user_id && $currentUser->id != $product->assignee_id) {
    ...
    public function update($id, UpdateNewsRequest $request)
    {
        ...
        // Clean redis key
        $cachedKeyMobile = "ntlt_mobile_".$product->slug;
        $cachedKeyDesktop = "ntlt_desktop_".$product->slug;
        try {
