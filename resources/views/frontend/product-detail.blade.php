                    ...
                    <div class="tt-product-single-info">
                       ...
                       <form onsubmit="return addToOrder(this);" enctype="multipart/form-data"
                        ...
                        <div class="tt-add-info col-12" style="margin-bottom:10px;">
                            <p class="title_1" style="margin-bottom: -10px !important;">Gọi tư vấn cho tôi:</p>
                            <form  action="{{ route('product_contact') }}" method="post" onsubmit="return contactProductDetail(this);" class="mdds-none">
                                <div class="input_dathang w100 contactInput" style="display: flex;">
                                    <input type="text"  id="call-me_phone"  name="phone_number" class="form-control emailSubmit w80 ds-inline" placeholder="Số ĐT của bạn" >
                                    ...
                                    <button class="submit_phone2 col-4" type="submit" >Gọi cho tôi</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="ml-auto col-md-6">
                      ...
                      <ul class="socical-share">
                        ...
                        <div class="permission">
                            ...
                            Bài viết chỉ nhằm mục đích cung cấp thông tin cho bạn đọc về sản phẩm, không nhằm mục đích thay thế cho tư vấn, chẩn đoán hoặc điều trị y tế. Bệnh nhân không tự ý sử dụng sản phẩm nếu chưa có chỉ định của y bác sĩ. Nhà Thuốc Lotus xin chân thành cảm ơn!
                        </div>
                    </div>
                                     ...
                                     @if($item['just_view'] == 0)
                                        <div class="tt-price">
                                            @if($item['price'] > 0)
                                                ...
                                                @endif
                                            @else
                                                <span class="lq-new-price" style="font-size: 20px !important;">Liên hệ</span>
                                            @endif
                                        </div>
                                        @else
                                        <div class="tt-price">
                                            <span class="lq-new-price" style="font-size: 20px !important;">Xem chi tiết</span>
                                        </div>
                                        @endif
                                </div>
                            </div>
