            ...
            <div class="container">
                <div class="tt-header-holder">
                    <div class="tt-col-obj tt-obj-logo tt-obj-menu-categories tt-desctop-parent-menu-categories">
                        <a class="tt-logo tt-logo-alignment tt-menu-categories" title="Trang chủ nhathuoclotus.com" href="/">
                            <img src="/images/logo_nhathuoclotus.png" alt="Logo nhathuoclotus.com" style="height: 50px;">
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="tt-mobile-collapse">
                            ...
                            <div class="tt-collapse-content">
                                <p>
                                    Đội ngũ dược sĩ với chuyên môn cao luôn dốc lòng vì sức khỏe cộng đồng. Tư vấn tận tâm, sản phẩm thật, giá tốt nhất.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="tt-newsletter">
                            <div class="tt-mobile-collapse">
                                ...
                                <div class="tt-collapse-content">
                                    <address>
                                        <p><span>Địa chỉ: </span>{{Constant::OFFICE_ADDRESS}}</p>
                                        <p><span>Phone: </span> 
                ...
                <div class="tt-row">
                    <div class="tt-col-left">
                        <div class="tt-col-item">
                            <div class="tt-box-copyright">Copyright ©2021 - Bản quyền thuộc về Nhà Thuốc Lotus</div>
                        </div>
                        <div class="dmca">
